...
// API_APP.patch("/blogs/:title", async (req, res) => {
// 	let title = req.params.title;
// 	let newBody = req.body.body;

// 	if (typeof title !== "string" || typeof newBody !== "string") {
// 		res.status(400).send("Bad Request");
// 		return;
// 	}

// 	blogs.updateOne({ title: title }, { body: newBody }).then((result) => {
...
// API_APP.delete("/blogs/:title", (req, res) => {
// 	let title = req.params.title;
...
// 			res.send(200).json({ count: result.deletedCount });
// 			return;
// 		})
// 		.catch((err) => {
// 			console.log(err);
